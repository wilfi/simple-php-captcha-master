...
class SimpleCaptcha{
 public function simple_php_captcha($config = array()) {
	...
	$captcha_config = array(
		...
		'characters' => '0123456789abcdefghjkmnprstuvwxyz',
		'min_font_size' => 28,
		'max_font_size' => 28,
		'color' => '#666',
		'angle_min' => 0,
	...
	return array(
		...
		'image_src' => $image_src.'&'.http_build_query($captcha_config)
	);
...
if( isset($_GET['_CAPTCHA']) ) {
	...
	$captcha_config['backgrounds']		=	$_GET['backgrounds'];
	$captcha_config['color']			=	$_GET['color'];
	$captcha_config['angle_min']		=	$_GET['angle_min'];
	$captcha_config['angle_max']		=	$_GET['angle_max'];
	$captcha_config['fonts']			=	$_GET['fonts'];
	$captcha_config['min_font_size']	=	$_GET['min_font_size'];
	$captcha_config['max_font_size']	=	$_GET['max_font_size'];
	$captcha_config['code']				=	$_GET['code'];
	$captcha_config['shadow']			=	$_GET['shadow'];
	$captcha_config['shadow_color']		=	$_GET['shadow_color'];
	$captcha_config['shadow_offset_x']	=	$_GET['shadow_offset_x'];
	$captcha_config['shadow_offset_y']	=	$_GET['shadow_offset_y'];
